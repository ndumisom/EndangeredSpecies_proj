 ...
 * @author bq8222
 */
public class AddSpeciesServ extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        String homePage="AddSpeciesForm.jsp";
        ...
        try{
         ...
         //use the dataAccess object to invoke the insertUser method to add a user to the database
          boolean isSpeciesInserted= dataAccess.addSpecies(kind, category);         //check if records are available
          if(isSpeciesInserted){
               //record is inserted
                request.setAttribute("successMsg", "Species is inserted successfully");
            }   else
              //user not inserted
