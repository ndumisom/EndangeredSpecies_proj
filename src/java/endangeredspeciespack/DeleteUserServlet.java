    ...
    */
    ...
    throws ServletException, IOException {
       String username=request.getParameter("username"); //get username
         ...
         String homePage="usersEditList.jsp"; //home page for the login user
         try{
         ...
         //use the dataAccess object to invoke the insertUser method to add a user to the database
          boolean isUserInserted= dataAccess.deleteUser(username);
          //check if records are available
            if(isUserInserted){
               //record is inserted
                request.setAttribute("successMsg", "User is deleted successfully");
            }   else
              //user not inserted
