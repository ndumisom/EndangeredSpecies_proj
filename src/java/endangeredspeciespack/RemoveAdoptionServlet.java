 ...
 * @author bq8222
 */
public class RemoveAdoptionServlet extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
       String id=request.getParameter("id"); //get username
         ...
         String homePage="AdoptionsListPage.jsp"; //home page for the login user
         try{
         ...
         //use the dataAccess object to invoke the insertUser method to add a user to the database
          boolean isUserInserted= dataAccess.removeAdoption(id);
          //check if records are available
            if(isUserInserted){
               //record is inserted
                request.setAttribute("successMsg", "Adoption Dropped with Success");
            }   else
              //user not inserted
              request.setAttribute("errorMsg","Failed to Drop Adoption, if possible, please cosult the system administrator");  
